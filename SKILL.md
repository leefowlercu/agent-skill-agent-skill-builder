...
- [Workflow: Building Agent Skills](#workflow-building-agent-skills)
  ...
  - [Phase 4: Validation & Iteration](#phase-4-validation--iteration)
...
This workflow guides you through creating an Agent Skill from requirements to validation. The workflow is organized into four distinct phases:
...
**Phase 4: Validation & Iteration** - Validate the skill and refine based on feedback.
...
See [Gathering Requirements Workflow Step Reference](references/workflow/01-discovery/01-requirements-gathering/01-gathering-requirements.md) for detailed guidance.

### Stage 2: Analysis
**Objective**: Determine appropriate skill architecture

#### Step 2: Determining Archetype
See [Determining Archetype Workflow Step Reference](references/workflow/01-discovery/02-analysis/02-determining-archetype.md) for detailed guidance.
...
See [Planning Structure Workflow Step Reference](references/workflow/02-planning/03-design/03-planning-structure.md) for detailed guidance.
...
See [Generating SKILL.md Workflow Step Reference](references/workflow/03-implementation/04-foundation/04-generating-skill-md.md) for detailed guidance.

### Stage 5: References
**Objective**: Generate supporting documentation

#### Step 5: Generating Workflow References
See [Generating Workflow References Step Reference](references/workflow/03-implementation/05-references/05-generating-workflow-references.md) for detailed guidance.

#### Step 6: Generating Schemas
See [Generating Schemas Workflow Step Reference](references/workflow/03-implementation/05-references/06-generating-schemas.md) for detailed guidance.

### Stage 6: Automation
**Objective**: Generate executable components

#### Step 7: Generating Scripts
See [Generating Scripts Workflow Step Reference](references/workflow/03-implementation/06-automation/07-generating-scripts.md) for detailed guidance.
...
See [Validating Skill Workflow Step Reference](references/workflow/04-validation-and-iteration/07-quality-assurance/08-validating-skill.md) for detailed guidance.

### Stage 8: Refinement
**Objective**: Incorporate user feedback

#### Step 9: Iterating on Feedback
See [Iterating on Feedback Workflow Step Reference](references/workflow/04-validation-and-iteration/08-refinement/09-iterating-on-feedback.md) for detailed guidance.
